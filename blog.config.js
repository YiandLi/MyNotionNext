...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'YiandLi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || ' 一个普通的i人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'NLP,博客', // 网站关键词 英文逗号隔开
